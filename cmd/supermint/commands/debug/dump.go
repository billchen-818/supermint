...
var dumpCmd = &cobra.Command{
	...
	Short: "Continuously poll a Supermint process and dump debugging data into a single location",
	Long: `Continuously poll a Supermint process and dump debugging data into a single
...
func init() {
	dumpCmd.Flags().UintVar(
		...
		flagFrequency,
		30,
		"the frequency (seconds) in which to poll, aggregate and dump Supermint debug data",
	)
