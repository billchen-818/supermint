...
// debugging running Supermint processes.
var DebugCmd = &cobra.Command{
	Use:   "debug",
	Short: "A utility to kill or watch a Supermint process while aggregating debugging data",
}
...
func init() {
	...
	DebugCmd.PersistentFlags().StringVar(
		...
		flagNodeRPCAddr,
		"tcp://localhost:26657",
		"the Supermint node's RPC address (<host>:<port>)",
	)
