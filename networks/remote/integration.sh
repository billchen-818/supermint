...
# **turn on the go module, default is auto. The value is off, if supermint source code
#is downloaded under $GOPATH/src directory
echo "export GO111MODULE=on" >> ~/.profile

source ~/.profile

mkdir -p $GOPATH/src/github.com/supermint
cd $GOPATH/src/github.com/supermint
...
git clone https://github.com/vbhp/supermint.git
cd supermint
## build
make tools
make build
...
cd $GOPATH/src/github.com/vbhp/supermint/networks/remote/terraform
...
cd $GOPATH/src/github.com/vbhp/supermint/networks/remote/ansible

# create config dirs
supermint testnet

ansible-playbook -i inventory/digital_ocean.py -l sentrynet install.yml
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/vbhp/supermint/build/supermint -e CONFIGDIR=$GOPATH/src/github.com/vbhp/supermint/networks/remote/ansible/mytestnet
...
old_ansible_file=$GOPATH/src/github.com/vbhp/supermint/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
...
ExecStart=/usr/bin/supermint node --proxy_app=kvstore --p2p.persistent_peers=$id0@$ip0:26656,$id1@$ip1:26656,$id2@$ip2:26656,$id3@$ip3:26656
