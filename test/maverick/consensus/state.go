...
import (
	...
	cstypes "github.com/vbhp/supermint
	"github.com/vbhp/supermint
	tmevents "github.com/vbhp/supermint
	"github.com/vbhp/supermint
	tmjson "github.com/vbhp/supermint
	"github.com/vbhp/supermint
	tmmath "github.com/vbhp/supermint
	tmos "github.com/vbhp/supermint
	"github.com/vbhp/supermint
	"github.com/vbhp/supermint
	tmproto "github.com/vbhp/supermintes"
...
func (cs *State) updateToState(state sm.State) {
	...
	case cs.LastCommit == nil:
		// NOTE: when Supermintarts, it has no votes. reconstructLastCommit
...
func (cs *State) voteTime() time.Time {
	...
	// even if cs.LockedBlock != nil. See https://docs.supermint.com/master/spec/.
	timeIota := time.Duration(cs.state.ConsensusParams.Block.TimeIotaMs) * time.Millisecond
	if cs.LockedBlock != nil {
		// See the BFT time spec https://docs.supermint.com/master/spec/consensus/bft-time.html
