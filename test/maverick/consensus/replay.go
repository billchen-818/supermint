...
func (h *Handshaker) Handshake(proxyApp proxy.AppConns) error {
	...
	h.logger.Info("Completed ABCI Handshake - Supermintd App are synced",
...
func (h *Handshaker) ReplayBlocks(
	...
	if storeBlockHeight == stateBlockHeight {
		// Supermintn Commit and saved the state.
...
Did you reset Supermintthout resetting your application's data?`,
