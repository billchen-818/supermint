...
Running the integrations test will build a docker container with local version of supermint
...
- persistence tests
    - crash supermint at each of many predefined points, restart, and ensure it syncs properly with the app
