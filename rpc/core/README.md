...
The user can subscribe to events emitted by Supermintusing `/subscribe`. If
...
("client is not pulling messages fast enough"). If Supermintxits, all
subscriptions are canceled ("Supermintxited"). The user can unsubscribe
