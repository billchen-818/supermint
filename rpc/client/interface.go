...
to a supermint node, as well as higher-level functionality.

The main implementation for production code is client.HTTP, which
connects via http to the jsonrpc interface of the supermint node.
...
// string. see supermint/types/events.go
