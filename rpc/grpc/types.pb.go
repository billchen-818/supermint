...
// source: supermint/rpc/grpc/types.proto
...
func init() {
	proto.RegisterType((*RequestPing)(nil), "supermint.rpc.grpc.RequestPing")
	proto.RegisterType((*RequestBroadcastTx)(nil), "supermint.rpc.grpc.RequestBroadcastTx")
	proto.RegisterType((*ResponsePing)(nil), "supermint.rpc.grpc.ResponsePing")
	proto.RegisterType((*ResponseBroadcastTx)(nil), "supermint.rpc.grpc.ResponseBroadcastTx")
}

func init() { proto.RegisterFile("supermint/rpc/grpc/types.proto", fileDescriptor_0ffff5682c662b95) }
...
func (c *broadcastAPIClient) Ping(ctx context.Context, in *RequestPing, opts ...grpc.CallOption) (*ResponsePing, error) {
	...
	err := c.cc.Invoke(ctx, "/supermint.rpc.grpc.BroadcastAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastAPIClient) BroadcastTx(ctx context.Context, in *RequestBroadcastTx, opts ...grpc.CallOption) (*ResponseBroadcastTx, error) {
	...
	err := c.cc.Invoke(ctx, "/supermint.rpc.grpc.BroadcastAPI/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BroadcastAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supermint.rpc.grpc.BroadcastAPI/Ping",
	}
...
func _BroadcastAPI_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supermint.rpc.grpc.BroadcastAPI/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BroadcastAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "supermint.rpc.grpc.BroadcastAPI",
	...
	Metadata: "supermint/rpc/grpc/types.proto",
}
