...
func (h *Handshaker) Handshake(proxyApp proxy.AppConns) error {
	...
	h.logger.Info("Completed ABCI Handshake - Supermint and App are synced",
...
func (h *Handshaker) ReplayBlocks(
	...
	case storeBlockHeight < stateBlockHeight:
		// the state should never be ahead of the store (this is under supermint's control)
	...
	case storeBlockHeight > stateBlockHeight+1:
		// store should be at most one ahead of the state (this is under supermint's control)
	...
	if storeBlockHeight == stateBlockHeight {
		// Supermint ran Commit and saved the state.
...
Did you reset Supermint without resetting your application's data?`,
