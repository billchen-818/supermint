...
The community has provided a number of additional implementations, see the [Supermint Ecosystem](https://github.com/supermint/awesome#ecosystem)
...
- [The main spec](https://github.com/supermint/spec/blob/master/spec/abci/abci.md)
