...
// source: supermint/state/types.proto
...
func init() {
	proto.RegisterType((*ABCIResponses)(nil), "supermint.state.ABCIResponses")
	proto.RegisterType((*ValidatorsInfo)(nil), "supermint.state.ValidatorsInfo")
	proto.RegisterType((*ConsensusParamsInfo)(nil), "supermint.state.ConsensusParamsInfo")
	proto.RegisterType((*Version)(nil), "supermint.state.Version")
	proto.RegisterType((*State)(nil), "supermint.state.State")
}

func init() { proto.RegisterFile("supermint/state/types.proto", fileDescriptor_ccfacf933f22bf93) }
