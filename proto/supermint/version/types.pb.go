...
// source: supermint/version/types.proto
...
func init() {
	proto.RegisterType((*App)(nil), "supermint.version.App")
	proto.RegisterType((*Consensus)(nil), "supermint.version.Consensus")
}

func init() { proto.RegisterFile("supermint/version/types.proto", fileDescriptor_f9b42966edc5edad) }
