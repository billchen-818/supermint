...
// source: supermint/crypto/keys.proto
...
// PublicKey defines the keys available for use with SupermintValidators
...
func init() {
	proto.RegisterType((*PublicKey)(nil), "supermint.crypto.PublicKey")
}

func init() { proto.RegisterFile("supermint/crypto/keys.proto", fileDescriptor_cb048658b234868c) }
