...
// source: supermint/crypto/proof.proto
...
func init() {
	proto.RegisterType((*Proof)(nil), "supermint.crypto.Proof")
	proto.RegisterType((*ValueOp)(nil), "supermint.crypto.ValueOp")
	proto.RegisterType((*DominoOp)(nil), "supermint.crypto.DominoOp")
	proto.RegisterType((*ProofOp)(nil), "supermint.crypto.ProofOp")
	proto.RegisterType((*ProofOps)(nil), "supermint.crypto.ProofOps")
}

func init() { proto.RegisterFile("supermint/crypto/proof.proto", fileDescriptor_6b60b6ba2ab5b856) }
