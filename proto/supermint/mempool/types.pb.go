...
// source: supermint/mempool/types.proto
...
func init() {
	proto.RegisterType((*Txs)(nil), "supermint.mempool.Txs")
	proto.RegisterType((*Message)(nil), "supermint.mempool.Message")
}

func init() { proto.RegisterFile("supermint/mempool/types.proto", fileDescriptor_2af51926fdbcbc05) }
