...
// source: supermint/libs/bits/types.proto
...
func init() {
	proto.RegisterType((*BitArray)(nil), "supermint.libs.bits.BitArray")
}

func init() { proto.RegisterFile("supermint/libs/bits/types.proto", fileDescriptor_e91ab2672920d7d4) }
