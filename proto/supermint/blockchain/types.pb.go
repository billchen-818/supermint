...
// source: supermint/blockchain/types.proto
...
func init() {
	proto.RegisterType((*BlockRequest)(nil), "supermint.blockchain.BlockRequest")
	proto.RegisterType((*NoBlockResponse)(nil), "supermint.blockchain.NoBlockResponse")
	proto.RegisterType((*BlockResponse)(nil), "supermint.blockchain.BlockResponse")
	proto.RegisterType((*StatusRequest)(nil), "supermint.blockchain.StatusRequest")
	proto.RegisterType((*StatusResponse)(nil), "supermint.blockchain.StatusResponse")
	proto.RegisterType((*Message)(nil), "supermint.blockchain.Message")
}

func init() { proto.RegisterFile("supermint/blockchain/types.proto", fileDescriptor_2927480384e78499) }
