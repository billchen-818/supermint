...
// source: supermint/types/types.proto
...
import (
	...
	version "github.com/vbhp/supermint/proto/supermint/version"
)
...
// Header defines the structure of a Supermintblock header.
type Header struct {
	// basic block info
...
// consensus.
type Vote struct {
	Type             SignedMsgType `protobuf:"varint,1,opt,name=type,proto3,enum=supermint.types.SignedMsgType" json:"type,omitempty"`
...
type CommitSig struct {
	BlockIdFlag      BlockIDFlag `protobuf:"varint,1,opt,name=block_id_flag,json=blockIdFlag,proto3,enum=supermint.types.BlockIDFlag" json:"block_id_flag,omitempty"`
...
func init() {
	proto.RegisterEnum("supermint.types.BlockIDFlag", BlockIDFlag_name, BlockIDFlag_value)
	proto.RegisterEnum("supermint.types.SignedMsgType", SignedMsgType_name, SignedMsgType_value)
	proto.RegisterType((*PartSetHeader)(nil), "supermint.types.PartSetHeader")
	proto.RegisterType((*Part)(nil), "supermint.types.Part")
	proto.RegisterType((*BlockID)(nil), "supermint.types.BlockID")
	proto.RegisterType((*Header)(nil), "supermint.types.Header")
	proto.RegisterType((*Data)(nil), "supermint.types.Data")
	proto.RegisterType((*Vote)(nil), "supermint.types.Vote")
	proto.RegisterType((*Commit)(nil), "supermint.types.Commit")
	proto.RegisterType((*CommitSig)(nil), "supermint.types.CommitSig")
	proto.RegisterType((*Proposal)(nil), "supermint.types.Proposal")
	proto.RegisterType((*SignedHeader)(nil), "supermint.types.SignedHeader")
	proto.RegisterType((*LightBlock)(nil), "supermint.types.LightBlock")
	proto.RegisterType((*BlockMeta)(nil), "supermint.types.BlockMeta")
	proto.RegisterType((*TxProof)(nil), "supermint.types.TxProof")
}

func init() { proto.RegisterFile("supermint/types/types.proto", fileDescriptor_d3a6e55e2345de56) }
