...
// source: supermint/types/block.proto
...
func init() {
	proto.RegisterType((*Block)(nil), "supermint.types.Block")
}

func init() { proto.RegisterFile("supermint/types/block.proto", fileDescriptor_70840e82f4357ab1) }
