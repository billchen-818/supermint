...
// source: supermint/types/events.proto
...
func init() {
	proto.RegisterType((*EventDataRoundState)(nil), "supermint.types.EventDataRoundState")
}

func init() { proto.RegisterFile("supermint/types/events.proto", fileDescriptor_72cfafd446dedf7c) }
