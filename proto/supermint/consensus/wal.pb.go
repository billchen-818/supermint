...
// source: supermint/consensus/wal.proto
...
func init() {
	proto.RegisterType((*MsgInfo)(nil), "supermint.consensus.MsgInfo")
	proto.RegisterType((*TimeoutInfo)(nil), "supermint.consensus.TimeoutInfo")
	proto.RegisterType((*EndHeight)(nil), "supermint.consensus.EndHeight")
	proto.RegisterType((*WALMessage)(nil), "supermint.consensus.WALMessage")
	proto.RegisterType((*TimedWALMessage)(nil), "supermint.consensus.TimedWALMessage")
}

func init() { proto.RegisterFile("supermint/consensus/wal.proto", fileDescriptor_ed0b60c2d348ab09) }
