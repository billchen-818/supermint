...
// source: supermint/consensus/types.proto
...
import (
	...
	bits "github.com/vbhp/supermint/proto/supermint/libs/bits"
...
type HasVote struct {
	Height int64               `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Round  int32               `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	Type   types.SignedMsgType `protobuf:"varint,3,opt,name=type,proto3,enum=supermint.types.SignedMsgType" json:"type,omitempty"`
...
func init() {
	proto.RegisterType((*NewRoundStep)(nil), "supermint.consensus.NewRoundStep")
	proto.RegisterType((*NewValidBlock)(nil), "supermint.consensus.NewValidBlock")
	proto.RegisterType((*Proposal)(nil), "supermint.consensus.Proposal")
	proto.RegisterType((*ProposalPOL)(nil), "supermint.consensus.ProposalPOL")
	proto.RegisterType((*BlockPart)(nil), "supermint.consensus.BlockPart")
	proto.RegisterType((*Vote)(nil), "supermint.consensus.Vote")
	proto.RegisterType((*HasVote)(nil), "supermint.consensus.HasVote")
	proto.RegisterType((*VoteSetMaj23)(nil), "supermint.consensus.VoteSetMaj23")
	proto.RegisterType((*VoteSetBits)(nil), "supermint.consensus.VoteSetBits")
	proto.RegisterType((*Message)(nil), "supermint.consensus.Message")
}

func init() { proto.RegisterFile("supermint/consensus/types.proto", fileDescriptor_81a22d2efc008981) }
