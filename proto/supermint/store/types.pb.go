...
// source: supermint/store/types.proto
...
func init() {
	proto.RegisterType((*BlockStoreState)(nil), "supermint.store.BlockStoreState")
}

func init() { proto.RegisterFile("supermint/store/types.proto", fileDescriptor_ff9e53a0a74267f7) }
