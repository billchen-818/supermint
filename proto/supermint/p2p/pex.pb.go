...
// source: supermint/p2p/pex.proto
...
func init() {
	proto.RegisterType((*PexRequest)(nil), "supermint.p2p.PexRequest")
	proto.RegisterType((*PexAddrs)(nil), "supermint.p2p.PexAddrs")
	proto.RegisterType((*Message)(nil), "supermint.p2p.Message")
}

func init() { proto.RegisterFile("supermint/p2p/pex.proto", fileDescriptor_81c2f011fd13be57) }
