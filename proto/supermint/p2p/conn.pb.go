...
// source: supermint/p2p/conn.proto
...
func init() {
	proto.RegisterType((*PacketPing)(nil), "supermint.p2p.PacketPing")
	proto.RegisterType((*PacketPong)(nil), "supermint.p2p.PacketPong")
	proto.RegisterType((*PacketMsg)(nil), "supermint.p2p.PacketMsg")
	proto.RegisterType((*Packet)(nil), "supermint.p2p.Packet")
	proto.RegisterType((*AuthSigMessage)(nil), "supermint.p2p.AuthSigMessage")
}

func init() { proto.RegisterFile("supermint/p2p/conn.proto", fileDescriptor_22474b5527c8fa9f) }
